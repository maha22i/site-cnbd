        ...
        <section className="container mx-auto px-4 max-w-5xl flex flex-col md:flex-row gap-8 py-12">
          ...
          <div className="flex-1 flex flex-col gap-8" data-aos="fade-right">
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <h1 className="text-3xl font-bold text-cnbd-black mb-4">Rejoignez l'aventure CNBD</h1>
              <p className="text-gray-700 mb-6">Vous souhaitez évoluer dans une entreprise innovante, humaine et en pleine croissance ? Nous recherchons des talents passionnés pour accompagner nos clients dans leur transformation digitale.</p>
              ...
              <ul className="space-y-4 mb-6">
                <li className="flex items-center gap-4">
                  ...
                  <span className="text-gray-800 font-medium">Ambiance bienveillante & équipe soudée</span>
                </li>
                <li className="flex items-center gap-4">
                  <span className="inline-flex items-center justify-center bg-cnbd-red/10 text-cnbd-red rounded-full w-10 h-10">
                  ...
                  <span className="text-gray-800 font-medium">Projets variés & technologies modernes</span>
                </li>
                <li className="flex items-center gap-4">
                  <span className="inline-flex items-center justify-center bg-cnbd-red/10 text-cnbd-red rounded-full w-10 h-10">
                  ...
                  <span className="text-gray-800 font-medium">Évolution & formation continue</span>
                </li>
              </ul>

              <div className="bg-gray-50 rounded-xl p-6">
                <p className="text-cnbd-red font-bold text-lg mb-2">Pourquoi nous rejoindre ?</p>
                <p className="text-gray-700">Chez CNBD, chaque talent compte. Nous valorisons l'initiative, la créativité et l'esprit d'équipe. Rejoignez-nous pour construire ensemble l'IT de demain !</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 bg-white rounded-2xl shadow-xl p-8" data-aos="fade-left">
            <h2 className="text-2xl font-bold text-cnbd-red mb-3">Formulaire de recrutement</h2>
            <p className="text-gray-600 mb-6">Merci de remplir tous les champs pour postuler à nos offres.</p>
            ...
            <form className="space-y-6">
              ...
              <div>
                <label htmlFor="job" className="block text-sm font-medium text-gray-700 mb-1">Poste souhaité</label>
                <input 
                  type="text" 
                  name="job" 
                  id="job" 
              ...
              <div>
                ...
                <textarea 
                  ...
                  required 
                  className="w-full rounded-lg border-gray-200 shadow-sm focus:ring-2 focus:ring-cnbd-red focus:border-transparent p-3" 
                  placeholder="Exprimez vos motivations, vos atouts, vos attentes..."
                ></textarea>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="cover" className="block text-sm font-medium text-gray-700 mb-1">Lettre de motivation (PDF)</label>
                  <input 
                    type="file" 
                    name="cover" 
                    id="cover" 
